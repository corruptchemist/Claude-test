...
PARTS = [
    ("LEAD",    "Lead",    56, clef.TrebleClef),   # brass lead / synth lead
    ("COUNTER", "Counter", 61, clef.TrebleClef),   # brass section
    ("SUSTAIN", "Sustain", 49, clef.TrebleClef),   # strings
    ("STABS",   "Stabs",   17, clef.TrebleClef),   # organ / guitar upstrokes
    ("KEYS",    "Keys",     0, clef.TrebleClef),   # piano
    ("BASS",    "Bass",    33, clef.BassClef),     # electric bass
...
METER_AT = {1: (4, 4)}
TEMPO_AT = {1: 95, 73: 148, 137: 126}
KEY_AT = {1: -4, 69: 2, 137: -1}
TEXT_AT = {71: "rit.", 73: "a tempo", 135: "poco rit.", 137: "a tempo",
           197: "allargando"}

MARKS = {1: "I. FLOWER", 9: "A", 25: "B", 41: "A'", 57: "build",
         65: "bridge", 69: "= A#dim7", 73: "II. GLAMOUR", 81: "A",
         97: "B", 113: "A'", 129: "bridge", 137: "III. BAD TIME",
         145: "A", 161: "B", 169: "A'", 177: "converge", 185: "motto",
         193: "coda"}
...
def build():
    ...
    sc.metadata.subtitle = "variations after Toby Fox · Finale / Death by Glamour / MEGALOVANIA"
    ...
    for pkey, pname, prog, clef_cls in PARTS:
        ...
        bars = T2.PARTS[pkey]
        measures = []
        first_note = {}      # measure -> first Note/Chord in it
        last_note = {}
        pending_tie = False
        ...
        for i, raw in enumerate(bars):
            ...
            src = T.DRUM_LIB[raw] if pkey == "DRUMS" else raw
