...
VOICES = {
    ...
    2:  ("saw",     0.150, 0.060, 0.14, 0.86, 0.18,  0.18),  # Choir
    3:  ("sine",    0.130, 0.001, 0.35, 0.05, 0.30,  0.26),  # Bell
    4:  ("saw",     0.150, 0.100, 0.20, 0.85, 0.26,  0.32),  # Chord pad
    5:  ("pulse12", 0.130, 0.002, 0.04, 0.28, 0.05,  0.44),  # Guitar offbeat
    6:  ("dist",    0.225, 0.002, 0.05, 0.70, 0.05, -0.42),  # Distorted guitar
    7:  ("saw",     0.190, 0.045, 0.12, 0.88, 0.12,  0.10),  # Low brass
    8:  ("tri",     0.160, 0.003, 0.04, 0.58, 0.05, -0.26),  # Arp engine
    10: ("square",  0.340, 0.003, 0.06, 0.82, 0.05,  0.00),  # Bass
    11: ("sine",    0.300, 0.010, 0.10, 0.90, 0.08,  0.00),  # Sub bass
}
# channels that get an echo send, and how much
DELAY = {0: 0.26, 2: 0.14, 3: 0.22}
